      ...
      >
        <div className="my-popup-page">
          ...
          <div className="tag-box">
            ...
            <div className="txt-option">仅支持上下级之间互转</div>
          </div>
          <div className="input-box">
            <div className="input-hint-txt-option">
              <div className="txt-option">互转数量:</div>
              <div className="txt-option right-txt">待释放积分：2,805.78</div>
            </div>
            <div
            ...
            >
              ...
              />
              <div className="input-txt">积分</div>
            </div>
          </div>

         <div className="input-box">
            <div className="input-hint-txt-option">
              <div className="txt-option">收款账户:</div>
            </div>
           <div
            className={`input-option ${isBalanceFocus ? "input-focus" : ""}`}
          >
            <Input
              placeholder="输入收款账户钱包地址"
          ...
          <div className="btn-submit">确认互转</div>
        </div>
      </Popup>
    </>
  );
