        ...
        <div className="box inviteBox">
          <div className="inviteTop">
            <div className="leftOption">
              <div className="txt">邀请奖励</div>
              <div className="price">3,508.56</div>
            </div>
            <div className="rightOption">
              <div className="btn">奖励明细</div>
            </div>
          </div>
          <div className="inviteEnd">
            <span className="spn1">邀请链接：</span>
            <span className="spn2">www.timetax.io/home/</span>
            <img src={copyIcon} className="copyIcon"></img>
          </div>
        </div>

        <div className="hintTeamListTxt">团队列表</div>
        <div className="box teamList">
          <div className="teamHeaderOption">
            <div className="itemTxt">钱包地址</div>
            <div className="itemTxt">类型</div>
            <div className="itemTxt itemTxtRight">贡献业绩(USDT)</div>
          </div>
