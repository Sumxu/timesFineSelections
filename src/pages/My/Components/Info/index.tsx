    ...
    <>
      <div className="my-info-box">
        ...
        <div className="btn-box">
          <div className="btn-option btn-withdraw">{t('提现')}</div>
          <div className="btn-option  btn-conversion">{t('兑换')}</div>
        </div>
        <div className="info-tax-balance-box">
          ...
          <div className="info-tax-balance-option">
            ...
            <div className="right-option" onClick={()=>navigate('/assetDetails')}>{t('资产明细')}</div>
          </div>
        </div>
      </div>
