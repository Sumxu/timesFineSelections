...
const PayResult: React.FC = () => {
  return (
      <div className="PayResultPage">
        <LeftBackHeader title="支付结果"></LeftBackHeader>
        <div className="paySuccessBox">
          <div className="iconBox">
            <img src={paySuccess} className="icon"></img>
          </div>
          <div className="payTxt">支付成功</div>
          ...
          <div className="payInfoBox">
            <div className="payInfoItem">
              <span className="spn1">商品金额：</span>
              <span className="spn1 color1">193.56</span>
            </div>
            <div className="payInfoItem">
              <span className="spn1">补贴积分：</span>
              <span className="spn1 color1">193.56</span>
            </div>
            <div className="payInfoItem">
              <span className="spn1">支付方式：</span>
              <span className="spn1 color1">USDT</span>
            </div>
          </div>
        </div>
        <div className="btnList">
          <div className="btn bg1">返回首页</div>
          <div className="btn bg2">查看订单</div>
        </div>
      </div>
  );
};
